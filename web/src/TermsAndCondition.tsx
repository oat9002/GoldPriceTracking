    ...
    return (
        <Content>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to GoldPriceTracking, accessible from{" "}
                        <a
            ...
            <p>
                Without limiting the foregoing, neither the Company nor any of the compan&quot;s
            ...
            <ul>
                <li>
                    ...
                    <a
                        href="https://github.com/oat9002"
                        rel="external nofollow noopener noreferrer"
                        target="_blank"
                    >
                        https://github.com/oat9002
                    </a>
                </li>
            </ul>
        </Content>
